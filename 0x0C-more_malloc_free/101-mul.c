...
/**
 * is_digit - function checks if a string contains a non-digit characters
 * @s: string paased to the function to be evaluated
 * Return: 0 if a non-digit is found, 1 if non found
 */
